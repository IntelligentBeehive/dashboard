                    ...
                    this.state.loading ?
                        ...
                        <div className={classes.chartContainer}>
                            ...
                            >
                                ...
                                <XAxis dataKey="date">
                                    <Label value="Temperature over time" offset={-25} position="insideBottom" />
                                </XAxis>
                                <YAxis label={<AxisLabel axisType="yAxis" x={25} y={125} width={0} height={0}>Temperature in celcius</AxisLabel>}/>
