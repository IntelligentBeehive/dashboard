...
import styles from './weight-chart.styles';
            ...
            <React.Fragment>
                {
                    this.state.loading ?
                        ...
                        <div className={classes.chartContainer}>
                            <Typography className={classes.chartTitle}>Weight overview</Typography>
                            ...
                            >
                                ...
                                <XAxis dataKey="date">
                                    <Label value="Weight over time" offset={-25} position="insideBottom" />
                                </XAxis>
                                <YAxis label={<AxisLabel axisType="yAxis" x={25} y={125} width={0} height={0}>Weight in grams</AxisLabel>}/>
